  ...
  return (
    <div className={`${styles.visualizationContainer} ${isLayerView ? styles.layerMode : ''}`}>
        ...
        <div className={`${styles.layerView} ${isLayerView ? styles.active : ''}`}>
            ...
            <div className={styles.cakeLayer} style={{ flex: 1.8, background: cremeColor1 }}><span className={styles.layerLabel}>Creme 1</span></div>
            {cake.gellyType && (
            ...
            {/* Middle Sponge */}
            <div className={styles.cakeLayer} style={{ flex: 2.5, background: spongeColor }}><span className={styles.layerLabel}>Sponge</span></div>
            <div className={styles.cakeLayer} style={{ flex: 1.8, background: cremeColor2 }}><span className={styles.layerLabel}>Creme 2</span></div>
            {cake.crispType && (
